...
<div class="main-content">
	<div class="wrap">
		<div class="main-box">
		   <div class="box_wrapper"><h1>Yamaha Bikes</h1></div>
		   
			<div class="section group">
			
				<div class="col_1_of_4 span_1_of_4">
					<img src="images/r1.jpeg" alt="" style="width: 287px; height : 150px;"/>
					<div class="grid_desc">
						<p class="title">R1</p>
					</div>
					<div class="Details">
				     <a href="r1.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">Details<span></span></a></div>
				</div>
