...
{   // receive all input values from the form
   ...
   $getmodelno= mysqli_query($db, "SELECT model from model where name = '".$cmodel."'");
    ...
    $checkcar= mysqli_query($db, "SELECT * from vehicle where model = '".$dbmodelno."'");
    ...
    if($numrows3 !=0)
    {
              $getuserid= mysqli_query($db, "SELECT c_id from customer where name = '".$user."'");
                ...
                if($numrows2 !=0)
                {
                 ...
                 $carupdate = " DELETE from vehicle where model = '".$dbmodelno."' LIMIT 1 ";
                mysqli_query($db, $carupdate);
                $orderupdate = " INSERT into sale2 (customer_id,vehiclemodel) VALUES ('$dbuserid', '$dbmodelno')";
    ...
    {
       $message = "Oops ! the vehicle you searching for is currently not available ! ";
         echo "<script type='text/javascript'>alert('$message');</script>";
    }	
}
?>
...
<div class="header-bottom">
	<div class="wrap">
        ...
        <form class="text-center" action="booking.php" method="post" >
           ...
           <div>
               <label>Select Your Bike/Car Model</label><br>
              ...
              <select name = "model" style="width:575px; height: 40px;" >
				...
				<option value = "GSA1250">BMW GS150 adventure</option>
				<option value = "S1000R">BMW S1000R</option>
				<option value = ""> </option>


				<option value = "Panigale"> Ducati Panigale v4</option>
				<option value = "Multistrada">Ducati Mutlistrada 1260</option>
				<option value = "Superleggera">Ducati Superleggera v4</option>
				<option value = ""> </option>


				<option value = "H2R"> Kawasaki H2R</option>
				<option value = "Versys">Kawasaki Versys1000</option>
				<option value = "ZX10R">Kawasaki NinjaZX10R</option>
				<option value = ""> </option>

				<option value = "R1">Yamaha R1</option>
				<option value = ""> </option>

				<option value = "CBR-1000RR">Honda CBR1000RR</option>
				<option value = "Goldwing">Honda Goldwing</option>
				<option value = "Africa twin">Honda Africa Twin</option>
				<option value = ""> </option>
             ...
             <div><br>
                <button type="submit" name="book" class="btn btn-warning" value="book">Book the vehicle</button>
             </div>
